	...
	<div id="page-invoice" class="pt-md-5">
		<div class="container d-flex justify-content-center">
			<div class="col-12 col-lg-11 px-0">
				<div id="">
					<div class="card border-0 mb-0 mb-md-5 py-md-4">
								...
								<div class="col-12 col-lg-9">
									...
									<div class="d-block d-md-flex align-items-center justify-content-between pb-4 pt-3 pt-md-3 mb-4 bb-solid">
										<div>
											...
											<div class="color-grey mb-3 mb-md-2">salinan atau ringkasan pesanan Anda telah dikirim ke <div class="d-none d-md-block"></div>Email cristianoronaldo07@gmail.com</div>
										</div>
									...
									<div class="mb-2 pb-md-4 pt-4 pb-2 bb-solid">
										<div class="row mb-3 mb-md-4" id="detail-order-status">
											<div class="col-12 col-md-6 col-lg-3 d-flex justify-content-between d-md-block mb-2 mb-md-3">
												<div class="fw-bold head-label">Order Date</div>
												<div class="color-grey">
												16 December, 2022 <div class="d-none d-md-block"></div> 14:49 PM
												</div>
											</div>
											<div class="col-12 col-md-6 col-lg-3 d-flex justify-content-between d-md-block mb-2 mb-md-3">
											...
											<div class="col-12 col-md-6 col-lg-2 d-flex justify-content-between d-md-block mb-2 mb-md-0">
												<div class="fw-bold head-label">Payment</div>
												<div class="color-grey">
												Permata VA
												</div>
											</div>
											<div class="col-12 col-md-6 col-lg-4 d-flex justify-content-between d-md-block">
